...
params.vsearch_db = "$projectDir/databases/silva-138-99-seqs.qza"
params.vsearch_tax = "$projectDir/databases/silva-138-99-tax.qza"
...
process import_qiime2 {
  ...
  qiime tools import --type 'SampleData[SequencesWithQuality]' \
    ...
    --output-path samples_${task.index}.qza \
